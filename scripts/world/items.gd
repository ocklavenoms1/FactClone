...
const DATA: Dictionary = {
	...
	Type.FLOUR:          { "name": "Flour",          "color": Color(0.95, 0.92, 0.85), "max_stack": 100, "description": "" },
	Type.YEAST:          { "name": "Yeast",          "color": Color(0.85, 0.75, 0.55), "max_stack":  50, "description": "" },
	Type.DOUGH:          { "name": "Dough",          "color": Color(0.92, 0.86, 0.70), "max_stack":  50, "description": "" },
	Type.SUGAR_BEET:     { "name": "Sugar Beet",     "color": Color(0.65, 0.20, 0.30), "max_stack": 100, "description": "" },
	Type.SUGAR:          { "name": "Sugar",          "color": Color(0.98, 0.96, 0.94), "max_stack": 100, "description": "" },
	Type.GRAIN:          { "name": "Grain",          "color": Color(0.88, 0.72, 0.32), "max_stack": 100, "description": "" },
	Type.STRAW:          { "name": "Straw",          "color": Color(0.85, 0.78, 0.40), "max_stack": 100, "description": "" },
	Type.RISEN_DOUGH:    { "name": "Risen Dough",    "color": Color(0.95, 0.88, 0.74), "max_stack":  50, "description": "" },
	Type.BREAD:          { "name": "Bread",          "color": Color(0.78, 0.55, 0.30), "max_stack":  50, "description": "" },
	Type.LOAF_PACK:      { "name": "Loaf Pack",      "color": Color(0.55, 0.40, 0.25), "max_stack":  50, "description": "" },
	Type.FUEL_BRIQUETTE: { "name": "Fuel Briquette", "color": Color(0.30, 0.22, 0.18), "max_stack": 100, "description": "" },
	Type.FLAX:           { "name": "Flax",           "color": Color(0.55, 0.72, 0.78), "max_stack": 100, "description": "" },
	Type.FIBER:          { "name": "Fiber",          "color": Color(0.86, 0.84, 0.76), "max_stack": 100, "description": "" },
	Type.CLOTH:          { "name": "Cloth",          "color": Color(0.92, 0.80, 0.62), "max_stack": 100, "description": "" },
	Type.BAG:            { "name": "Bag",            "color": Color(0.55, 0.30, 0.18), "max_stack": 100, "description": "" },
	# --- mining (colors match ResourceNodes.color_of for visual continuity) ---
	Type.RAW_STONE:      { "name": "Raw Stone",      "color": Color(0.55, 0.55, 0.58), "max_stack": 200, "description": "" },
	Type.COAL:           { "name": "Coal",           "color": Color(0.18, 0.18, 0.22), "max_stack": 200, "description": "" },
	Type.IRON_ORE:       { "name": "Iron Ore",       "color": Color(0.62, 0.45, 0.38), "max_stack": 100, "description": "" },
	Type.COPPER_ORE:     { "name": "Copper Ore",     "color": Color(0.45, 0.55, 0.65), "max_stack": 100, "description": "" },
	Type.CLAY:           { "name": "Clay",           "color": Color(0.68, 0.50, 0.36), "max_stack": 200, "description": "" },
	# --- tree harvesting (color matches tree trunk, not canopy — the produced item is wood) ---
	Type.WOOD:           { "name": "Wood",           "color": Color(0.50, 0.32, 0.18), "max_stack": 200, "description": "" },
	...
	Type.IRON_INGOT:     { "name": "Iron Ingot",     "color": Color(0.55, 0.55, 0.62), "max_stack": 100, "description": "" },
	Type.COPPER_INGOT:   { "name": "Copper Ingot",   "color": Color(0.78, 0.55, 0.40), "max_stack": 100, "description": "" },
	...
	Type.COMPOST_LOW:    { "name": "Low Compost",    "color": Color(0.55, 0.40, 0.25), "max_stack": 100, "description": "" },
	Type.COMPOST_MID:    { "name": "Rich Compost",   "color": Color(0.38, 0.27, 0.16), "max_stack": 100, "description": "" },
	# Premium Compost (Session 4): near-black brown — top of the gradient.
	# Made from food waste (bread / loaf_pack); restores wasteland.
	Type.COMPOST_HIGH:   { "name": "Premium Compost", "color": Color(0.22, 0.16, 0.10), "max_stack": 100, "description": "" },
}
